...
BOOST_AUTO_TEST_CASE(addrman_simple)
{
    ...
    CService addr1 = ResolveService("250.1.1.1", 1865);
    BOOST_CHECK(addrman->Add({CAddress(addr1, NODE_NONE)}, source));
    BOOST_CHECK_EQUAL(addrman->size(), 1U);
    auto addr_ret1 = addrman->Select().first;
    BOOST_CHECK_EQUAL(addr_ret1.ToString(), "250.1.1.1:1865");

    // Test: Does IP address deduplication work correctly.
    //  Expected dup IP should not be added.
    CService addr1_dup = ResolveService("250.1.1.1", 1865);
    ...
    CService addr2 = ResolveService("250.1.1.2", 1865);
    ...
    vAddr.push_back(CAddress(ResolveService("250.1.1.3", 1865), NODE_NONE));
    vAddr.push_back(CAddress(ResolveService("250.1.1.4", 1865), NODE_NONE));
...
BOOST_AUTO_TEST_CASE(addrman_ports)
{
    ...
    CService addr1_port = ResolveService("250.1.1.1", 1866);
    BOOST_CHECK(addrman->Add({CAddress(addr1_port, NODE_NONE)}, source));
    BOOST_CHECK_EQUAL(addrman->size(), 2U);
    auto addr_ret2 = addrman->Select().first;
    BOOST_CHECK(addr_ret2.ToString() == "250.1.1.1:1865" || addr_ret2.ToString() == "250.1.1.1:8334");
    ...
    BOOST_CHECK_EQUAL(addr_ret3.ToString(), "250.1.1.1:1865");
}
...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    CService addr2 = ResolveService("250.3.1.1", 1865);
    CService addr3 = ResolveService("250.3.2.2", 9999);
    CService addr4 = ResolveService("250.3.3.3", 9999);

    BOOST_CHECK(addrman->Add({CAddress(addr2, NODE_NONE)}, ResolveService("250.3.1.1", 1865)));
    BOOST_CHECK(addrman->Add({CAddress(addr3, NODE_NONE)}, ResolveService("250.3.1.1", 1865)));
    BOOST_CHECK(addrman->Add({CAddress(addr4, NODE_NONE)}, ResolveService("250.4.1.1", 1865)));

    // Add three addresses to tried table.
    CService addr5 = ResolveService("250.4.4.4", 1865);
    CService addr6 = ResolveService("250.4.5.5", 7777);
    CService addr7 = ResolveService("250.4.6.6", 1865);

    BOOST_CHECK(addrman->Add({CAddress(addr5, NODE_NONE)}, ResolveService("250.3.1.1", 1865)));
    BOOST_CHECK(addrman->Good(CAddress(addr5, NODE_NONE)));
    BOOST_CHECK(addrman->Add({CAddress(addr6, NODE_NONE)}, ResolveService("250.3.1.1", 1865)));
    BOOST_CHECK(addrman->Good(CAddress(addr6, NODE_NONE)));
    BOOST_CHECK(addrman->Add({CAddress(addr7, NODE_NONE)}, ResolveService("250.1.1.3", 1865)));
...
{
    auto addrman = TestAddrMan();
    CAddress addr{CAddress(ResolveService("253.3.3.3", 1865), NODE_NONE)};
...
BOOST_AUTO_TEST_CASE(addrman_getaddr)
{
    ...
    CAddress addr1 = CAddress(ResolveService("250.250.2.1", 1865), NODE_NONE);
    addr1.nTime = GetAdjustedTime(); // Set time so isTerrible = false
    CAddress addr2 = CAddress(ResolveService("250.251.2.2", 9999), NODE_NONE);
    addr2.nTime = GetAdjustedTime();
    CAddress addr3 = CAddress(ResolveService("251.252.2.3", 1865), NODE_NONE);
    addr3.nTime = GetAdjustedTime();
    CAddress addr4 = CAddress(ResolveService("252.253.3.4", 1865), NODE_NONE);
    addr4.nTime = GetAdjustedTime();
    CAddress addr5 = CAddress(ResolveService("252.254.4.5", 1865), NODE_NONE);
...
{
    CAddress addr1 = CAddress(ResolveService("250.1.1.1", 1865), NODE_NONE);
...
{
    CAddress addr1 = CAddress(ResolveService("250.1.2.1", 1865), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(load_addrman)
{
    ...
    BOOST_CHECK(Lookup("250.7.1.1", addr1, 1865, false));
    ...
    // Add three addresses to new table.
    CService source;
    BOOST_CHECK(Lookup("252.5.1.1", source, 1865, false));
...
BOOST_AUTO_TEST_CASE(addrman_update_address)
{
    ...
    auto addrman = TestAddrMan();
    CNetAddr source{ResolveIP("252.2.2.2")};
    CAddress addr{CAddress(ResolveService("250.1.1.1", 1865), NODE_NONE)};
